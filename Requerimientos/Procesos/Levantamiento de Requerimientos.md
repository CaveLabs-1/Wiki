...
2 | Análisis |<ul><li>Identificar y documentar mediante un Process Flow Diagram el proceso de la empresa sobre el que tendrá impacto el proyecto</li> <li>Identificar panorama de la problemática y documentarlo en el documento de contexto de la problemática(Llenar CDD)</li></ul> | Product Owner | RM RD
...
7 | Validación |<ul><li>Se valida PDD y lista de requerimientos con el cliente, firma de acuerdo de stakeholder principal y product owner</li></ul> | Product Owner, Configuration Manager | PPQA
...
2.1 | Se siguen estándares de calidad | Alejandro Salmón | Valter Nuñez | 3/mayo/2018
